...
public class GoogleCloudAiplatformV1FeatureViewIndexConfig {
  ...
  public GoogleCloudAiplatformV1FeatureViewIndexConfig() {
  }

  public GoogleCloudAiplatformV1FeatureViewIndexConfig treeAhConfig(GoogleCloudAiplatformV1FeatureViewIndexConfigTreeAHConfig treeAhConfig) {
  ...
  public void setTreeAhConfig(GoogleCloudAiplatformV1FeatureViewIndexConfigTreeAHConfig treeAhConfig) {
    this.treeAhConfig = treeAhConfig;
  }


  public GoogleCloudAiplatformV1FeatureViewIndexConfig crowdingColumn(String crowdingColumn) {
  ...
  public GoogleCloudAiplatformV1FeatureViewIndexConfig bruteForceConfig(Object bruteForceConfig) {
  ...
  public GoogleCloudAiplatformV1FeatureViewIndexConfig distanceMeasureType(DistanceMeasureTypeEnum distanceMeasureType) {
  ...
  public GoogleCloudAiplatformV1FeatureViewIndexConfig embeddingDimension(Integer embeddingDimension) {
  ...
  public GoogleCloudAiplatformV1FeatureViewIndexConfig embeddingColumn(String embeddingColumn) {
  ...
  public GoogleCloudAiplatformV1FeatureViewIndexConfig filterColumns(List<String> filterColumns) {
    this.filterColumns = filterColumns;
    return this;
  }

  public GoogleCloudAiplatformV1FeatureViewIndexConfig addFilterColumnsItem(String filterColumnsItem) {
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudAiplatformV1FeatureViewIndexConfig googleCloudAiplatformV1FeatureViewIndexConfig = (GoogleCloudAiplatformV1FeatureViewIndexConfig) o;
    return Objects.equals(this.treeAhConfig, googleCloudAiplatformV1FeatureViewIndexConfig.treeAhConfig) &&
        Objects.equals(this.crowdingColumn, googleCloudAiplatformV1FeatureViewIndexConfig.crowdingColumn) &&
        Objects.equals(this.bruteForceConfig, googleCloudAiplatformV1FeatureViewIndexConfig.bruteForceConfig) &&
        Objects.equals(this.distanceMeasureType, googleCloudAiplatformV1FeatureViewIndexConfig.distanceMeasureType) &&
        Objects.equals(this.embeddingDimension, googleCloudAiplatformV1FeatureViewIndexConfig.embeddingDimension) &&
        Objects.equals(this.embeddingColumn, googleCloudAiplatformV1FeatureViewIndexConfig.embeddingColumn) &&
        Objects.equals(this.filterColumns, googleCloudAiplatformV1FeatureViewIndexConfig.filterColumns);
  }

  @Override
  public int hashCode() {
    return Objects.hash(treeAhConfig, crowdingColumn, bruteForceConfig, distanceMeasureType, embeddingDimension, embeddingColumn, filterColumns);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GoogleCloudAiplatformV1FeatureViewIndexConfig {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudAiplatformV1FeatureViewIndexConfig
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudAiplatformV1FeatureViewIndexConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudAiplatformV1FeatureViewIndexConfig is not found in the empty JSON string", GoogleCloudAiplatformV1FeatureViewIndexConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudAiplatformV1FeatureViewIndexConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudAiplatformV1FeatureViewIndexConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // validate the optional field `treeAhConfig`
      if (jsonObj.get("treeAhConfig") != null && !jsonObj.get("treeAhConfig").isJsonNull()) {
        GoogleCloudAiplatformV1FeatureViewIndexConfigTreeAHConfig.validateJsonElement(jsonObj.get("treeAhConfig"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudAiplatformV1FeatureViewIndexConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudAiplatformV1FeatureViewIndexConfig' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudAiplatformV1FeatureViewIndexConfig> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudAiplatformV1FeatureViewIndexConfig.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudAiplatformV1FeatureViewIndexConfig>() {
           @Override
           public void write(JsonWriter out, GoogleCloudAiplatformV1FeatureViewIndexConfig value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudAiplatformV1FeatureViewIndexConfig read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudAiplatformV1FeatureViewIndexConfig given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudAiplatformV1FeatureViewIndexConfig
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudAiplatformV1FeatureViewIndexConfig
   */
  public static GoogleCloudAiplatformV1FeatureViewIndexConfig fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudAiplatformV1FeatureViewIndexConfig.class);
  }

  /**
   * Convert an instance of GoogleCloudAiplatformV1FeatureViewIndexConfig to an JSON string
   *
   * @return JSON string
   */
