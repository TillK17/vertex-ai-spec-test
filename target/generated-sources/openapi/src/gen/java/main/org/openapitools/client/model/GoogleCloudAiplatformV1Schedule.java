...
import org.openapitools.client.model.GoogleCloudAiplatformV1CreateNotebookExecutionJobRequest;
...
public class GoogleCloudAiplatformV1Schedule {
  ...
  public static final String SERIALIZED_NAME_CREATE_NOTEBOOK_EXECUTION_JOB_REQUEST = "createNotebookExecutionJobRequest";
  @SerializedName(SERIALIZED_NAME_CREATE_NOTEBOOK_EXECUTION_JOB_REQUEST)
  ...
  public GoogleCloudAiplatformV1Schedule() {
  }
  ...
  public GoogleCloudAiplatformV1Schedule displayName(String displayName) {
  ...
  public GoogleCloudAiplatformV1Schedule allowQueueing(Boolean allowQueueing) {
  ...
  public GoogleCloudAiplatformV1Schedule cron(String cron) {
    this.cron = cron;
    return this;
  }
  ...
  public GoogleCloudAiplatformV1Schedule endTime(String endTime) {
  ...
  public GoogleCloudAiplatformV1Schedule createNotebookExecutionJobRequest(GoogleCloudAiplatformV1CreateNotebookExecutionJobRequest createNotebookExecutionJobRequest) {
  ...
  public void setCreateNotebookExecutionJobRequest(GoogleCloudAiplatformV1CreateNotebookExecutionJobRequest createNotebookExecutionJobRequest) {
    this.createNotebookExecutionJobRequest = createNotebookExecutionJobRequest;
  }
  ...
  public GoogleCloudAiplatformV1Schedule maxConcurrentRunCount(String maxConcurrentRunCount) {
  ...
  public GoogleCloudAiplatformV1Schedule maxRunCount(String maxRunCount) {
  ...
  public GoogleCloudAiplatformV1Schedule startTime(String startTime) {
  ...
  public GoogleCloudAiplatformV1Schedule name(String name) {
    this.name = name;
    return this;
  }
  ...
  public GoogleCloudAiplatformV1Schedule createPipelineJobRequest(GoogleCloudAiplatformV1CreatePipelineJobRequest createPipelineJobRequest) {
  ...
  public void setCreatePipelineJobRequest(GoogleCloudAiplatformV1CreatePipelineJobRequest createPipelineJobRequest) {
    this.createPipelineJobRequest = createPipelineJobRequest;
  }
  ...
  public boolean equals(Object o) {
    ...
    GoogleCloudAiplatformV1Schedule googleCloudAiplatformV1Schedule = (GoogleCloudAiplatformV1Schedule) o;
    return Objects.equals(this.lastPauseTime, googleCloudAiplatformV1Schedule.lastPauseTime) &&
        Objects.equals(this.displayName, googleCloudAiplatformV1Schedule.displayName) &&
        Objects.equals(this.nextRunTime, googleCloudAiplatformV1Schedule.nextRunTime) &&
        Objects.equals(this.lastScheduledRunResponse, googleCloudAiplatformV1Schedule.lastScheduledRunResponse) &&
        Objects.equals(this.allowQueueing, googleCloudAiplatformV1Schedule.allowQueueing) &&
        Objects.equals(this.createTime, googleCloudAiplatformV1Schedule.createTime) &&
        Objects.equals(this.startedRunCount, googleCloudAiplatformV1Schedule.startedRunCount) &&
        Objects.equals(this.lastResumeTime, googleCloudAiplatformV1Schedule.lastResumeTime) &&
        Objects.equals(this.cron, googleCloudAiplatformV1Schedule.cron) &&
        Objects.equals(this.endTime, googleCloudAiplatformV1Schedule.endTime) &&
        Objects.equals(this.createNotebookExecutionJobRequest, googleCloudAiplatformV1Schedule.createNotebookExecutionJobRequest) &&
        Objects.equals(this.catchUp, googleCloudAiplatformV1Schedule.catchUp) &&
        Objects.equals(this.maxConcurrentRunCount, googleCloudAiplatformV1Schedule.maxConcurrentRunCount) &&
        Objects.equals(this.state, googleCloudAiplatformV1Schedule.state) &&
        Objects.equals(this.maxRunCount, googleCloudAiplatformV1Schedule.maxRunCount) &&
        Objects.equals(this.startTime, googleCloudAiplatformV1Schedule.startTime) &&
        Objects.equals(this.name, googleCloudAiplatformV1Schedule.name) &&
        Objects.equals(this.createPipelineJobRequest, googleCloudAiplatformV1Schedule.createPipelineJobRequest) &&
        Objects.equals(this.updateTime, googleCloudAiplatformV1Schedule.updateTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(lastPauseTime, displayName, nextRunTime, lastScheduledRunResponse, allowQueueing, createTime, startedRunCount, lastResumeTime, cron, endTime, createNotebookExecutionJobRequest, catchUp, maxConcurrentRunCount, state, maxRunCount, startTime, name, createPipelineJobRequest, updateTime);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GoogleCloudAiplatformV1Schedule {\n");
    ...
    sb.append("    createNotebookExecutionJobRequest: ").append(toIndentedString(createNotebookExecutionJobRequest)).append("\n");
  ...
  static {
    ...
    openapiFields.add("createNotebookExecutionJobRequest");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GoogleCloudAiplatformV1Schedule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleCloudAiplatformV1Schedule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GoogleCloudAiplatformV1Schedule is not found in the empty JSON string", GoogleCloudAiplatformV1Schedule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleCloudAiplatformV1Schedule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GoogleCloudAiplatformV1Schedule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("lastScheduledRunResponse") != null && !jsonObj.get("lastScheduledRunResponse").isJsonNull()) {
        GoogleCloudAiplatformV1ScheduleRunResponse.validateJsonElement(jsonObj.get("lastScheduledRunResponse"));
      }
      ...
      // validate the optional field `createNotebookExecutionJobRequest`
      if (jsonObj.get("createNotebookExecutionJobRequest") != null && !jsonObj.get("createNotebookExecutionJobRequest").isJsonNull()) {
        GoogleCloudAiplatformV1CreateNotebookExecutionJobRequest.validateJsonElement(jsonObj.get("createNotebookExecutionJobRequest"));
      }
      ...
      if (jsonObj.get("createPipelineJobRequest") != null && !jsonObj.get("createPipelineJobRequest").isJsonNull()) {
        GoogleCloudAiplatformV1CreatePipelineJobRequest.validateJsonElement(jsonObj.get("createPipelineJobRequest"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GoogleCloudAiplatformV1Schedule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GoogleCloudAiplatformV1Schedule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GoogleCloudAiplatformV1Schedule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GoogleCloudAiplatformV1Schedule.class));

       return (TypeAdapter<T>) new TypeAdapter<GoogleCloudAiplatformV1Schedule>() {
           @Override
           public void write(JsonWriter out, GoogleCloudAiplatformV1Schedule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GoogleCloudAiplatformV1Schedule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GoogleCloudAiplatformV1Schedule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GoogleCloudAiplatformV1Schedule
   * @throws IOException if the JSON string is invalid with respect to GoogleCloudAiplatformV1Schedule
   */
  public static GoogleCloudAiplatformV1Schedule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GoogleCloudAiplatformV1Schedule.class);
  }

  /**
   * Convert an instance of GoogleCloudAiplatformV1Schedule to an JSON string
   *
   * @return JSON string
   */
