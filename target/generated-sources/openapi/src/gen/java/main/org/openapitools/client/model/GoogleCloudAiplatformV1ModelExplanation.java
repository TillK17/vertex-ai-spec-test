...
public class GoogleCloudAiplatformV1ModelExplanation {
  ...
  public GoogleCloudAiplatformV1ModelExplanation meanAttributions(List<GoogleCloudAiplatformV1Attribution> meanAttributions) {
    this.meanAttributions = meanAttributions;
    return this;
  }

  public GoogleCloudAiplatformV1ModelExplanation addMeanAttributionsItem(GoogleCloudAiplatformV1Attribution meanAttributionsItem) {
    if (this.meanAttributions == null) {
      this.meanAttributions = new ArrayList<>();
    }
    this.meanAttributions.add(meanAttributionsItem);
    return this;
  }
  ...
  public void setMeanAttributions(List<GoogleCloudAiplatformV1Attribution> meanAttributions) {
    this.meanAttributions = meanAttributions;
  }
