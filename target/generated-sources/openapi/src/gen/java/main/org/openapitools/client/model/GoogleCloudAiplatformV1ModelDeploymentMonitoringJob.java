...
public class GoogleCloudAiplatformV1ModelDeploymentMonitoringJob {
  ...
  private Any samplePredictInstance = null;
  ...
  public GoogleCloudAiplatformV1ModelDeploymentMonitoringJob(
     String createTime, 
     GoogleCloudAiplatformV1ModelDeploymentMonitoringJobLatestMonitoringPipelineMetadata latestMonitoringPipelineMetadata, 
  ...
  public GoogleCloudAiplatformV1ModelDeploymentMonitoringJob samplePredictInstance(Any samplePredictInstance) {
   ...
   */
  @javax.annotation.Nullable
  public Any getSamplePredictInstance() {
    return samplePredictInstance;
  }

  public void setSamplePredictInstance(Any samplePredictInstance) {
    this.samplePredictInstance = samplePredictInstance;
  }
  ...
  public GoogleCloudAiplatformV1ModelDeploymentMonitoringJob bigqueryTables(List<GoogleCloudAiplatformV1ModelDeploymentMonitoringBigQueryTable> bigqueryTables) {
    this.bigqueryTables = bigqueryTables;
    return this;
  }

  public GoogleCloudAiplatformV1ModelDeploymentMonitoringJob addBigqueryTablesItem(GoogleCloudAiplatformV1ModelDeploymentMonitoringBigQueryTable bigqueryTablesItem) {
    if (this.bigqueryTables == null) {
      this.bigqueryTables = new ArrayList<>();
    }
    this.bigqueryTables.add(bigqueryTablesItem);
    return this;
  }
  ...
  public void setBigqueryTables(List<GoogleCloudAiplatformV1ModelDeploymentMonitoringBigQueryTable> bigqueryTables) {
    this.bigqueryTables = bigqueryTables;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.logTtl, googleCloudAiplatformV1ModelDeploymentMonitoringJob.logTtl) &&
        ...
        Objects.equals(this.satisfiesPzi, googleCloudAiplatformV1ModelDeploymentMonitoringJob.satisfiesPzi) &&
        Objects.equals(this.analysisInstanceSchemaUri, googleCloudAiplatformV1ModelDeploymentMonitoringJob.analysisInstanceSchemaUri) &&
        ...
        Objects.equals(this.satisfiesPzs, googleCloudAiplatformV1ModelDeploymentMonitoringJob.satisfiesPzs) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(logTtl, createTime, statsAnomaliesBaseDirectory, enableMonitoringPipelineLogs, latestMonitoringPipelineMetadata, labels, modelDeploymentMonitoringScheduleConfig, encryptionSpec, predictInstanceSchemaUri, scheduleState, satisfiesPzi, analysisInstanceSchemaUri, modelDeploymentMonitoringObjectiveConfigs, samplePredictInstance, state, loggingSamplingStrategy, displayName, name, satisfiesPzs, endpoint, error, nextScheduleTime, modelMonitoringAlertConfig, bigqueryTables, updateTime);
  }
