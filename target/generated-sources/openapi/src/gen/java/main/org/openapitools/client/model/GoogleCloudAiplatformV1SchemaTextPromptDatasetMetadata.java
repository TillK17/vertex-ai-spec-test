...
public class GoogleCloudAiplatformV1SchemaTextPromptDatasetMetadata {
  public static final String SERIALIZED_NAME_HAS_PROMPT_VARIABLE = "hasPromptVariable";
  @SerializedName(SERIALIZED_NAME_HAS_PROMPT_VARIABLE)
  private Boolean hasPromptVariable;
  ...
  public static final String SERIALIZED_NAME_SYSTEM_INSTRUCTION_GCS_URI = "systemInstructionGcsUri";
  @SerializedName(SERIALIZED_NAME_SYSTEM_INSTRUCTION_GCS_URI)
  private String systemInstructionGcsUri;
  ...
  public GoogleCloudAiplatformV1SchemaTextPromptDatasetMetadata hasPromptVariable(Boolean hasPromptVariable) {
  ...
  public Boolean getHasPromptVariable() {
    return hasPromptVariable;
  }

  public void setHasPromptVariable(Boolean hasPromptVariable) {
    this.hasPromptVariable = hasPromptVariable;
  }
  ...
  public GoogleCloudAiplatformV1SchemaTextPromptDatasetMetadata systemInstructionGcsUri(String systemInstructionGcsUri) {
   ...
   */
  @javax.annotation.Nullable
  public String getSystemInstructionGcsUri() {
    return systemInstructionGcsUri;
  }

  public void setSystemInstructionGcsUri(String systemInstructionGcsUri) {
    this.systemInstructionGcsUri = systemInstructionGcsUri;
  }


  public GoogleCloudAiplatformV1SchemaTextPromptDatasetMetadata systemInstruction(String systemInstruction) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.hasPromptVariable, googleCloudAiplatformV1SchemaTextPromptDatasetMetadata.hasPromptVariable) &&
        ...
        Objects.equals(this.systemInstructionGcsUri, googleCloudAiplatformV1SchemaTextPromptDatasetMetadata.systemInstructionGcsUri) &&
        Objects.equals(this.systemInstruction, googleCloudAiplatformV1SchemaTextPromptDatasetMetadata.systemInstruction) &&
        ...
        Objects.equals(this.candidateCount, googleCloudAiplatformV1SchemaTextPromptDatasetMetadata.candidateCount) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hasPromptVariable, stopSequences, temperature, systemInstructionGcsUri, systemInstruction, groundingConfig, maxOutputTokens, topK, note, candidateCount, text, promptType, gcsUri, topP);
  }
  ...
  public String toString() {
    ...
    sb.append("    hasPromptVariable: ").append(toIndentedString(hasPromptVariable)).append("\n");
    sb.append("    stopSequences: ").append(toIndentedString(stopSequences)).append("\n");
    sb.append("    temperature: ").append(toIndentedString(temperature)).append("\n");
    sb.append("    systemInstructionGcsUri: ").append(toIndentedString(systemInstructionGcsUri)).append("\n");
  ...
  static {
    ...
    openapiFields.add("hasPromptVariable");
    openapiFields.add("stopSequences");
    openapiFields.add("temperature");
    openapiFields.add("systemInstructionGcsUri");
    openapiFields.add("systemInstruction");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("systemInstructionGcsUri") != null && !jsonObj.get("systemInstructionGcsUri").isJsonNull()) && !jsonObj.get("systemInstructionGcsUri").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `systemInstructionGcsUri` to be a primitive type in the JSON string but got `%s`", jsonObj.get("systemInstructionGcsUri").toString()));
      }
      if ((jsonObj.get("systemInstruction") != null && !jsonObj.get("systemInstruction").isJsonNull()) && !jsonObj.get("systemInstruction").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `systemInstruction` to be a primitive type in the JSON string but got `%s`", jsonObj.get("systemInstruction").toString()));
      }
