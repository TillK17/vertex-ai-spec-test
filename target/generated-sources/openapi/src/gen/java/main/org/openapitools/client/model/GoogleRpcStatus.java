...
public class GoogleRpcStatus {
  ...
  private List<Map<String, Any>> details = new ArrayList<>();
  ...
  public GoogleRpcStatus details(List<Map<String, Any>> details) {
    this.details = details;
    return this;
  }

  public GoogleRpcStatus addDetailsItem(Map<String, Any> detailsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<Map<String, Any>> getDetails() {
    return details;
  }

  public void setDetails(List<Map<String, Any>> details) {
    this.details = details;
  }
