...
public class GoogleCloudAiplatformV1Execution {
  ...
  public GoogleCloudAiplatformV1Execution metadata(Map<String, Any> metadata) {
    this.metadata = metadata;
    return this;
  }

  public GoogleCloudAiplatformV1Execution putMetadataItem(String key, Any metadataItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.schemaVersion, googleCloudAiplatformV1Execution.schemaVersion) &&
        Objects.equals(this.metadata, googleCloudAiplatformV1Execution.metadata) &&
        Objects.equals(this.createTime, googleCloudAiplatformV1Execution.createTime) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(schemaVersion, metadata, createTime, labels, name, updateTime, displayName, description, state, schemaTitle, etag);
  }
