...
public class GoogleCloudAiplatformV1Model {
  ...
  public GoogleCloudAiplatformV1Model supportedOutputStorageFormats(List<String> supportedOutputStorageFormats) {
    this.supportedOutputStorageFormats = supportedOutputStorageFormats;
    return this;
  }

  public GoogleCloudAiplatformV1Model addSupportedOutputStorageFormatsItem(String supportedOutputStorageFormatsItem) {
    if (this.supportedOutputStorageFormats == null) {
      this.supportedOutputStorageFormats = new ArrayList<>();
    }
    this.supportedOutputStorageFormats.add(supportedOutputStorageFormatsItem);
    return this;
  }
  ...
  public GoogleCloudAiplatformV1Model supportedInputStorageFormats(List<String> supportedInputStorageFormats) {
    this.supportedInputStorageFormats = supportedInputStorageFormats;
    return this;
  }

  public GoogleCloudAiplatformV1Model addSupportedInputStorageFormatsItem(String supportedInputStorageFormatsItem) {
    if (this.supportedInputStorageFormats == null) {
      this.supportedInputStorageFormats = new ArrayList<>();
    }
    this.supportedInputStorageFormats.add(supportedInputStorageFormatsItem);
    return this;
  }
  ...
  public GoogleCloudAiplatformV1Model baseModelSource(GoogleCloudAiplatformV1ModelBaseModelSource baseModelSource) {
  ...
  public void setBaseModelSource(GoogleCloudAiplatformV1ModelBaseModelSource baseModelSource) {
    this.baseModelSource = baseModelSource;
  }
  ...
  public GoogleCloudAiplatformV1Model deployedModels(List<GoogleCloudAiplatformV1DeployedModelRef> deployedModels) {
    this.deployedModels = deployedModels;
    return this;
  }

  public GoogleCloudAiplatformV1Model addDeployedModelsItem(GoogleCloudAiplatformV1DeployedModelRef deployedModelsItem) {
  ...
  public void setDeployedModels(List<GoogleCloudAiplatformV1DeployedModelRef> deployedModels) {
    this.deployedModels = deployedModels;
  }
  ...
  public GoogleCloudAiplatformV1Model metadata(Any metadata) {
  ...
  public GoogleCloudAiplatformV1Model supportedDeploymentResourcesTypes(List<SupportedDeploymentResourcesTypesEnum> supportedDeploymentResourcesTypes) {
    this.supportedDeploymentResourcesTypes = supportedDeploymentResourcesTypes;
    return this;
  }

  public GoogleCloudAiplatformV1Model addSupportedDeploymentResourcesTypesItem(SupportedDeploymentResourcesTypesEnum supportedDeploymentResourcesTypesItem) {
    if (this.supportedDeploymentResourcesTypes == null) {
      this.supportedDeploymentResourcesTypes = new ArrayList<>();
    }
    this.supportedDeploymentResourcesTypes.add(supportedDeploymentResourcesTypesItem);
    return this;
  }
  ...
  public void setSupportedDeploymentResourcesTypes(List<SupportedDeploymentResourcesTypesEnum> supportedDeploymentResourcesTypes) {
    this.supportedDeploymentResourcesTypes = supportedDeploymentResourcesTypes;
  }
  ...
  public GoogleCloudAiplatformV1Model supportedExportFormats(List<GoogleCloudAiplatformV1ModelExportFormat> supportedExportFormats) {
    this.supportedExportFormats = supportedExportFormats;
    return this;
  }

  public GoogleCloudAiplatformV1Model addSupportedExportFormatsItem(GoogleCloudAiplatformV1ModelExportFormat supportedExportFormatsItem) {
    if (this.supportedExportFormats == null) {
      this.supportedExportFormats = new ArrayList<>();
    }
    this.supportedExportFormats.add(supportedExportFormatsItem);
    return this;
  }
  ...
  public void setSupportedExportFormats(List<GoogleCloudAiplatformV1ModelExportFormat> supportedExportFormats) {
    this.supportedExportFormats = supportedExportFormats;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.pipelineJob, googleCloudAiplatformV1Model.pipelineJob) &&
        ...
        Objects.equals(this.satisfiesPzs, googleCloudAiplatformV1Model.satisfiesPzs) &&
        Objects.equals(this.supportedInputStorageFormats, googleCloudAiplatformV1Model.supportedInputStorageFormats) &&
        Objects.equals(this.artifactUri, googleCloudAiplatformV1Model.artifactUri) &&
        ...
        Objects.equals(this.baseModelSource, googleCloudAiplatformV1Model.baseModelSource) &&
        ...
        Objects.equals(this.satisfiesPzi, googleCloudAiplatformV1Model.satisfiesPzi) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(pipelineJob, explanationSpec, supportedOutputStorageFormats, name, versionDescription, encryptionSpec, originalModelInfo, satisfiesPzs, supportedInputStorageFormats, artifactUri, metadataArtifact, predictSchemata, createTime, etag, containerSpec, baseModelSource, labels, versionUpdateTime, satisfiesPzi, deployedModels, dataStats, description, versionAliases, metadataSchemaUri, metadata, supportedDeploymentResourcesTypes, displayName, versionCreateTime, versionId, supportedExportFormats, updateTime, trainingPipeline, modelSourceInfo);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("baseModelSource") != null && !jsonObj.get("baseModelSource").isJsonNull()) {
        GoogleCloudAiplatformV1ModelBaseModelSource.validateJsonElement(jsonObj.get("baseModelSource"));
      }
