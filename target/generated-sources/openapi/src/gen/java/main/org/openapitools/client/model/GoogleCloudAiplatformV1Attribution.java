...
public class GoogleCloudAiplatformV1Attribution {
  ...
  private Any featureAttributions = null;
   ...
   */
  @javax.annotation.Nullable
  public Any getFeatureAttributions() {
    return featureAttributions;
  }
  ...
  public GoogleCloudAiplatformV1Attribution outputIndex(List<Integer> outputIndex) {
    this.outputIndex = outputIndex;
    return this;
  }

  public GoogleCloudAiplatformV1Attribution addOutputIndexItem(Integer outputIndexItem) {
    if (this.outputIndex == null) {
      this.outputIndex = new ArrayList<>();
    }
    this.outputIndex.add(outputIndexItem);
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.outputDisplayName, googleCloudAiplatformV1Attribution.outputDisplayName) &&
        ...
        Objects.equals(this.approximationError, googleCloudAiplatformV1Attribution.approximationError) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(outputDisplayName, featureAttributions, outputName, instanceOutputValue, approximationError, outputIndex, baselineOutputValue);
  }
